...
const DEFAULT_PLANNING_PLAYBOOK = [
  ...
  "4. Review — read the plan back, confirm details and ordering, and loop until",
  "   the user is satisfied. Disagreement means the interview wasn't finished.",
  "5. Only after explicit approval, call start_loop (bootstrap false — the plan",
